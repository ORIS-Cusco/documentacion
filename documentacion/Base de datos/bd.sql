...
CREATE TABLE observatorio.mant_unidad_funcional (
...
CREATE TABLE observatorio.mant_categorias (
...
CREATE TABLE observatorio.mant_temporalidad (
...
CREATE TABLE observatorio.mant_niveles_disgregacion (
...
CREATE TABLE observatorio.mant_items_disgregacion (
    id_item_disgregacion SERIAL PRIMARY KEY,
    id_nivel_disgregacion INT NOT NULL REFERENCES observatorio.mant_niveles_disgregacion(id_nivel_disgregacion) ON DELETE CASCADE,
...
CREATE TABLE observatorio.mant_indicadores (
    id_indicador SERIAL PRIMARY KEY,
    id_unidad_funcional INT NOT NULL REFERENCES observatorio.mant_unidad_funcional(id_unidad_funcional),
    id_categoria INT NOT NULL REFERENCES observatorio.mant_categorias(id_categoria),
    id_temporalidad INT NOT NULL REFERENCES observatorio.mant_temporalidad(id_temporalidad),
...
CREATE TABLE observatorio.rel_indicador_disgregacion (
    id_relacion SERIAL PRIMARY KEY,
    id_indicador INT NOT NULL REFERENCES observatorio.mant_indicadores(id_indicador) ON DELETE CASCADE,
    id_nivel_disgregacion INT NOT NULL REFERENCES observatorio.mant_niveles_disgregacion(id_nivel_disgregacion),
...
CREATE TABLE observatorio.data_institucional (
    id_registro BIGSERIAL PRIMARY KEY,
    id_indicador INT NOT NULL REFERENCES observatorio.mant_indicadores(id_indicador),
    id_unidad_funcional INT REFERENCES observatorio.mant_unidad_funcional(id_unidad_funcional),
    id_categoria INT REFERENCES observatorio.mant_categorias(id_categoria),
    anio INT NOT NULL,
...
CREATE TABLE observatorio.data_poblacional (
    id_registro BIGSERIAL PRIMARY KEY,
    id_indicador INT NOT NULL REFERENCES observatorio.mant_indicadores(id_indicador),
    id_categoria INT REFERENCES observatorio.mant_categorias(id_categoria),
    anio INT NOT NULL,
...
CREATE TABLE observatorio.control_reportes (
...
INSERT INTO seguridad.roles (nombre_rol, descripcion, usuario_registro) VALUES 
('ADMINISTRADOR', 'Acceso total al sistema', 'SISTEMA'),
('OPERADOR_LOCAL', 'Registro de datos para distritos', 'SISTEMA');

INSERT INTO observatorio.mant_unidad_funcional (nombre, descripcion, estado, usuario_registro) VALUES 
...
INSERT INTO observatorio.mant_categorias (id_categoria, nombre, descripcion, usuario_registro) VALUES 
...
INSERT INTO observatorio.mant_temporalidad (id_temporalidad, nombre, cantidad_dias, descripcion, usuario_registro) 
...
INSERT INTO observatorio.mant_indicadores (id_indicador, id_unidad_funcional, id_categoria, id_temporalidad, nombre_indicador, usuario_registro) VALUES 
-- Salud
